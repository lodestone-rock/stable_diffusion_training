...
text_encoder_params_2 = jax.tree_map(lambda x: jax.device_put(x, device=jax.devices()[0]), text_encoder_params_2)
...
pos_2, neg_2 = np.split(text_input_2.input_ids, 2, axis=0)
image = t2i(
